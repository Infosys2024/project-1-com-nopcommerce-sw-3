...
public class TestSuite  extends Utility {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        //2.22 Fill the all mandatory field
        sendTextToElement(By.id("BillingNewAddress_FirstName"), "Raj");
        sendTextToElement(By.id("BillingNewAddress_LastName"), "Patel");
        sendTextToElement(By.id("BillingNewAddress_Email"), "raj123@gmail.com");
        sendTextToElement(By.id("BillingNewAddress_Company"), "Pen");
        selectByVisibleTextFromDropDown(By.id("BillingNewAddress_CountryId"), "United Kingdom");
        sendTextToElement(By.id("BillingNewAddress_City"), "Scotland");
        sendTextToElement(By.id("BillingNewAddress_Address1"), "Down street");
        sendTextToElement(By.id("BillingNewAddress_ZipPostalCode"), "BN177JW");
        sendTextToElement(By.id("BillingNewAddress_PhoneNumber"), "+4478657488999");
        //2.23 Click on “CONTINUE”
        ...
        sendTextToElement(By.id("CardholderName"), "Raj Patel");
