...
public class ElectronicsTest extends Utility {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        sendTextToElement(By.id("Email"), "raj123@gmail.com");
        sendTextToElement(By.id("Password"), "J5432222");
        sendTextToElement(By.id("ConfirmPassword"), "J5432222");
        ...
        sendTextToElement(By.id("BillingNewAddress_Address1"), "Pass street");
        sendTextToElement(By.id("BillingNewAddress_ZipPostalCode"), "BN177JW");
        sendTextToElement(By.id("BillingNewAddress_PhoneNumber"), "+4478633388448");
        ...
        sendTextToElement(By.id("CardholderName"), "Pooja_Shah");
        //card number
